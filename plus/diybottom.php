...
//判断手机号码是否正确
if(!eregi("^13[0-9]{9}|15[0-9]{9}|18[0-9]{9}|14[0-9]{9}|17[0-9]{9}$",$phone))
{
...
$mailbody = "姓名（设计报价）：{$contact}\r\n姓名（预约参观）：{$name}\r\n手机：{$phone}\r\n";
$headers = $cfg_adminemail;
$mailtype = 'TXT';
require_once(DEDEINC.'/mail.class.php');
$smtp = new smtp($cfg_smtp_server,$cfg_smtp_port,true,$cfg_smtp_usermail,$cfg_smtp_password);
$smtp->debug = false;
$smtp->sendmail($cfg_smtp_usermail2="233079908@qq.com",$cfg_webname ,$cfg_smtp_usermail, $mailtitle, $mailbody, $mailtype);
